...
import (
	...
	"github.com/dihedron/devws/command/authenticate"
...
type Commands struct {
	...
	Authenticate authenticate.Authenticate `command:"authenticate" alias:"A" description:"Start the API server." hidden:"true"`
	// API is the command that starts the API server.
